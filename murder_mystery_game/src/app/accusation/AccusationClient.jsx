    ...
    suspects: [
      {
        ...
        className:
          "left-[3.8%] top-[-8.3%] w-[43%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "wife",
        image: "/c_assets/wife_acc.png",
        className:
          "right-[5.5%] top-[-0.5%] w-[36%] aspect-[3/4] grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "driver",
        image: "/c_assets/driver_acc.png",
        className:
          "left-[3.5%] bottom-[0.1%] w-[36%] aspect-[3/4] grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "gardener",
        image: "/c_assets/gardener_acc.png",
        className:
          "left-[29%] bottom-[6%] w-[26%] aspect-[3/4] grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "maid",
        image: "/c_assets/maid_acc.png",
        className:
          "right-[11%] bottom-[4.8%] w-[30%] aspect-[3/4] grayscale transition duration-100 hover:grayscale-0",
      },
    ],
    victim: {
  ...
  knives_out: {
    suspects: [
      ...
      },
      {
        ...
        className:
          "right-[10.5%] bottom-[1.7%] w-[33%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "grandson",
        image: "/c_assets/hugh_acc.png",
        className:
          "right-[9.5%] top-[4.5%] w-[35%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "daughter",
        image: "/c_assets/lin_acc.png",
        className:
          "left-[4.5%] w-[40%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
    ],
    victim: {
    ...
    suspects: [
      {
        ...
        className:
          "left-[4%] top-[1%] w-[43%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "partnership",
        image: "/c_assets/winston_acc.png",
        className:
          "left-[7%] bottom-[-4.5%] w-[37%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "technical",
        image: "/c_assets/yanmei_acc.png",
        className:
          "right-[12%] top-[5.5%] w-[36%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
      {
        id: "secretary",
        image: "/c_assets/rey_acc.png",
        className:
          "right-[10%] bottom-[1%] w-[34%] aspect-[3/4] focus:outline-none grayscale transition duration-100 hover:grayscale-0",
      },
    ],
    victim: {
...
export default function AccusationClient() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const storyId = searchParams.get("storyId");
  const story = storyId ? STORIES[storyId] : null;
  const corkboardImage = storyId
    ? CORKBOARD_ASSETS[storyId] || "/corkboard.png"
    : "/corkboard.png";
  ...
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-black px-6 py-10 text-white">
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center">
        <h1
          className={`${cinzel.className} mt-4 text-center text-5xl tracking-[0.16em] text-[#B22222]`}
        >
          Accusation Board
        </h1>
        ...
        <div className="relative -mt-8 aspect-[4/3] w-full max-w-5xl">
          ...
          <textarea
            ...
            className={`${patrickHand.className} absolute z-20 left-[40%] top-[24%] w-[20%] aspect-[21/9] resize-none text-zinc-600 tracking-[0.2rem] outline-none`}
          />
        </div>
      </div>
      <button
        ...
        className={`${caesarDressing.className} absolute bottom-[4%] z-10 text-4xl text-[#B22222] disabled:cursor-not-allowed disabled:opacity-50`}
      >
        CONFIRM
      </button>
    </main>
