...
const RESULT_CONTENT = {
  ...
  knives_out: {
    correct: {
      title: "The Murderer Revealed",
      message:
        "You unraveled the twisted family plot and uncovered the true mastermind behind the death.",
  ...
  sim_it_club: {
    correct: {
      ...
      message:
        "You revealed who poisoned Fuku and uncovered the truth hidden in the club room.",
      image: "/casethreecorrect.png",
    },
    wrong: {
      title: "The Real Culprit Escaped",
      message:
        "Your accusation ruined an innocent life. The real murderer is still among the EXCO",
      image: "/justicefailed.png",
    },
  },
};
    ...
    <main className="relative min-h-dvh overflow-hidden bg-black">
      {resultConfig.image ? (
        <div>
          ...
          <div
            className={`absolute left-[10%] bottom-[20%] rounded-[2rem] border border-white/30 p-10 text-center backdrop-blur-xs ${
              isCorrect
                ? "shadow-[0_0_8px_rgba(110,231,183,0.35),0_0_24px_rgba(110,231,183,0.25),0_0_48px_rgba(110,231,183,0.18)]"
          ...
          >
            ...
            <p className="text-md mt-6 tracking-[0.1em] text-zinc-300">
